package com.lulu.teoremus.enums

import com.lulu.teoremus.R

enum class Escolhas(val som: Int) {
     MELODIA_LA_VIE(R.raw.melo_la_vie),
     ...
     ACORDE_NORMAL_AUMENTADO_DIMINUTO(R.raw.acorde_nor_aum_dim),
